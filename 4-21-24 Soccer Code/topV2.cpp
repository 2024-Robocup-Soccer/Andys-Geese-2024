...
// char lastMove = 'r'; int lastMoveTime;
...
//         }
//         else if (angle == 180)
//         // else if ((angle <= 210 && angle >= 180) || (angle <= 180 && angle >= 60))
//         {
//             if(lastMove == 'l') {
//                 Serial7.write(3);
//                 lastMoveTime++;
...
//             }
//             if(lastMove == 'l' && lastMoveTime >= 25) {
//                 Serial7.write(3);
//                 lastMove = 'r';
//                 lastMoveTime = 0;
//             }
//             else if(lastMove == 'r' && lastMoveTime >= 25) {
//                 Serial7.write(2);
//                 lastMove = 'l';
//                 lastMoveTime = 0;
//             }
//         }
//         else if ((angle > 210 && angle < 300) || (angle > 60 && angle < 150))
//         {
//             Serial7.write(4);
//         }
//     }
...
//     Serial.print(angle); Serial.print(" "); Serial.println(compassAngle);
